...
$message= $data->message;
 ...
 $msg = "
<div class='container' style='position:relative;width:90%;padding-top:5%;padding-bottom:5%;padding-right:5%;padding-left:5%;font-family:Trebuchet MS;background-color:#c2185b38;background-image:none;background-repeat:repeat;background-position:top left;background-attachment:scroll;text-align:center;margin-top:2%;margin-bottom:2%;margin-right:2%;margin-left:2%;' >
        <div class='head' style='width:100%;' >
          <h2>
           <u> Somuhle projects cleint query</u>
          </h2>
        </div>
...
$to = "sihle.gumede@somuhleprojects.com	,mrnnmthembu@gmail.com";
$subject = 'Somuhle projects Query- Via the website';
$from = $email;
